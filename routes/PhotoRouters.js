...
//Controller 
const { insertPhoto, deletePhoto, getAllPhotos, getUserPhotos, getPhotoById, updatePhoto, likePhotos, commentPhoto, searchPhotos } = require('../controllers/PhotoController');
...
router.put('/like/:id', authGuard, likePhotos);
